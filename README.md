# ZeleBoba Billing · 0.3 — FreeKassa

PHP-биллинг подписок для Remnawave: веб-кабинет, Telegram, FreeKassa (API) / ЮKassa и веб-админка. Подготовлен и проверен контейнерный кандидат для развёртывания. **Реальный приём денег включается только после проверки конкретного магазина, панели и публичного HTTPS-домена.**
