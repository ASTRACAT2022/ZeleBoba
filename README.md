...
- Синхронизация с Remnawave: `remnawave:sync` (CLI), кнопка в админке, автораз в час — сверка сроков/трафика/устройств, пересоздание пропавших пользователей, отключение истёкших.
