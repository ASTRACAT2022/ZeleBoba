...
final class Application
{
    ...
    private function handleRequest(Request $r): Response
    {
        ...
        try {
            ...
            if (in_array($handler,['yookassa','telegram','cryptobot','lava','wata','heleket','platega','tribute','mulenpay','pal24','cloudpayments','kassa_ai','riopay','severpay','paypear','rollypay','overpay','aurapay','etoplatezhi','antilopay','jupiter','donut','cispay','tabpay','paritypay'],true)) return $this->webhook($handler);
