...
final class Application
{
    ...
    public function handle(Request $r): Response
    {
        ...
        try {
            ...
            $response->headers->set('Content-Security-Policy',"default-src 'self'; style-src 'self' 'nonce-".$this->styleNonce."'; script-src 'self' https://telegram.org; connect-src 'self'; img-src 'self' data: https:; object-src 'none'; frame-ancestors 'none'; base-uri 'none'; form-action 'self'");
    ...
    private function handleRequest(Request $r): Response
    {
        ...
        try {
            if ($r->isMethod('GET') && $r->getPathInfo()==='/' && $r->query->has('ref')) {
                $this->app->auth->throttle('creator-click:'.$r->getClientIp(),120,60);
                $token=$this->app->creators->capture((string)$r->query->get('ref'),$r->query->get('campaign')?:null,$r->getClientIp());
                $response=new RedirectResponse('/',302);
                if ($token) $response->headers->setCookie($this->cookie('creator_attr',$token,time()+30*86400));
                return $response;
            }
            $routes=new RouteCollection();
            foreach ([['tg-start','/telegram/start',['POST']],['tg-status','/telegram/status',['GET']],['tg-finish','/telegram/finish',['POST']],['tg-magic','/telegram/magic',['GET','POST']],['security','/security',['GET']],['mfa-begin','/security/begin',['POST']],['mfa-enroll','/security/enroll',['POST']],['mfa-verify','/security/verify',['POST']],['admin-config','/admin/config',['GET']],['admin-config-save','/admin/config',['POST']],['admin-check','/admin/check/{id}',['POST']],['admin-readiness','/admin/readiness',['GET']],['admin-plans','/admin/plans',['GET']],['admin-plan-save','/admin/plans/{id}',['POST']],['admin-users','/admin/users',['GET']],['admin-user-search','/admin/users/search',['GET']],['admin-user-toggle','/admin/users/{id}/toggle',['POST']],['admin-user','/admin/users/{id}',['GET']],['admin-user-balance','/admin/users/{id}/balance',['POST']],['admin-user-days','/admin/users/{id}/days',['POST']],['admin-user-discount','/admin/users/{id}/discount',['POST']],['admin-user-discount-clear','/admin/users/{id}/discount/clear',['POST']],['admin-user-subscription-remove','/admin/users/{id}/subscriptions/{sid}/remove',['POST']],['admin-subscription','/admin/subscriptions/{sid}',['GET']],['admin-subscription-traffic','/admin/users/{id}/subscriptions/{sid}/traffic',['POST']],['admin-subscription-devices','/admin/users/{id}/subscriptions/{sid}/devices',['POST']],['admin-subscription-extend','/admin/users/{id}/subscriptions/{sid}/extend',['POST']],['admin-subscription-expiry','/admin/users/{id}/subscriptions/{sid}/expiry',['POST']],['admin-subscription-reset-traffic','/admin/users/{id}/subscriptions/{sid}/reset-traffic',['POST']],['admin-sync','/admin/sync',['POST']],['admin-promocodes','/admin/promocodes',['GET']],['admin-promocode-create','/admin/promocodes',['POST']],['admin-promocode-toggle','/admin/promocodes/{id}/toggle',['POST']],['admin-withdrawals','/admin/withdrawals',['GET']],['admin-withdrawal-process','/admin/withdrawals/{id}',['POST']],['admin-broadcasts','/admin/broadcasts',['GET']],['admin-broadcast-create','/admin/broadcasts',['POST']],['admin-compensations','/admin/compensations',['GET']],['admin-compensation-audit','/admin/compensations/{id}/audit',['GET']],['admin-compensation-create','/admin/compensations',['POST']],['admin-compensation-retry','/admin/compensations/{id}/retry',['POST']],['admin-channels','/admin/channels',['GET']],['admin-channel-add','/admin/channels',['POST']],['admin-channel-toggle','/admin/channels/{id}/toggle',['POST']],['admin-channel-remove','/admin/channels/{id}/remove',['POST']],['admin-landings','/admin/landings',['GET']],['admin-landing-save','/admin/landings',['POST']],['admin-landing-toggle','/admin/landings/{id}/toggle',['POST']],['admin-contests','/admin/contests',['GET']],['admin-contest-create','/admin/contests',['POST']],['admin-contest-round','/admin/contests/{id}/round',['POST']],['admin-polls','/admin/polls',['GET']],['admin-poll-create','/admin/polls',['POST']],['admin-campaigns','/admin/campaigns',['GET']],['admin-campaign-create','/admin/campaigns',['POST']],['admin-reports','/admin/reports',['GET']],['admin-monitoring','/admin/monitoring',['GET']],['admin-monitoring-clear','/admin/monitoring/clear',['POST']],['admin-backups','/admin/backups',['GET']],['admin-backup-create','/admin/backups',['POST']],['admin-backup-restore','/admin/backups/{id}/restore',['POST']],['admin-roles','/admin/roles',['GET']],['admin-role-create','/admin/roles',['POST']],['admin-role-assign','/admin/roles/assign',['POST']],['admin-role-revoke','/admin/roles/revoke',['POST']],['admin-audit','/admin/audit',['GET']],['admin-maintenance','/admin/maintenance',['POST']],['landing','/l/{id}',['GET']],['health','/health/live',['GET']],['ready','/health/ready',['GET']],['login','/login',['GET','POST']],['register','/register',['GET','POST']],['forgot','/forgot',['GET','POST']],['reset','/reset/{token}',['GET','POST']],['logout','/logout',['POST']],['home','/',['GET']],['plans','/plans',['GET']],['orders','/orders',['GET']],['buy','/orders',['POST']],['order','/orders/{id}',['GET']],['demo','/orders/{id}/demo-pay',['POST']],['autorenew','/subscriptions/{id}/autorenew',['POST']],['renew','/subscriptions/{id}/renew',['POST']],['merge','/subscriptions/merge',['POST']],['trial','/trial',['POST']],['trial-convert','/trial/{id}/convert',['POST']],['settings','/settings',['GET']],['link','/settings/telegram',['POST']],['promo','/promo',['POST']],['referral','/referral',['GET']],['withdraw','/referral/withdraw',['POST']],['gifts','/gifts',['GET']],['gift-buy','/gifts/buy',['POST']],['gift-claim','/gifts/claim',['POST']],['gift-claim-page','/gifts/claim',['GET']],['gift-buy-page','/buy/gift/{id}',['GET']],['balance','/balance',['GET']],['topup','/balance/topup',['POST']],['topup-order','/balance/topup/{id}',['GET']],['topup-demo','/balance/topup/{id}/demo-pay',['POST']],['buy-balance','/orders/balance',['POST']],['admin','/admin',['GET']],['retry','/admin/jobs/{id}/retry',['POST']],['plan','/admin/plans',['POST']],['platega','/webhooks/platega',['POST']],['telegram','/webhooks/telegram',['POST']]] as [$name,$path,$methods]) $routes->add($name,new Route($path,['_handler'=>$name],[],[], '',[],$methods));
            foreach ([['admin-operations','/admin/operations',['GET']],['admin-operation','/admin/operations/{id}',['GET']],['admin-events','/admin/events',['GET']],['admin-provisioning','/admin/provisioning',['GET']],['admin-provisioning-retry','/admin/provisioning/{id}/retry',['POST']],['admin-explain','/admin/subscriptions/{id}/explain',['GET']],['admin-flags','/admin/flags',['GET']],['admin-flag-save','/admin/flags',['POST']],['admin-switches','/admin/switches',['GET']],['admin-switch-save','/admin/switches',['POST']],['admin-breaker-reset','/admin/switches/breaker',['POST']],['admin-approvals','/admin/approvals',['GET']],['admin-approval-decision','/admin/approvals/{id}',['POST']],['admin-incidents','/admin/incidents',['GET']],['admin-incident-create','/admin/incidents',['POST']],['admin-preview-extend','/admin/subscriptions/{id}/preview-extend',['GET']],['admin-intelligence','/admin/intelligence',['GET']],['admin-invariants-run','/admin/intelligence/invariants',['POST']],['admin-safety-mode','/admin/intelligence/safety-mode',['POST']],['admin-maintenance-window','/admin/intelligence/maintenance',['POST']],['admin-simulator','/admin/users/{id}/simulate',['GET']],['admin-time-travel','/admin/users/{id}/state-at',['GET']],['admin-dependency-graph','/admin/subscriptions/{id}/graph',['GET']],['admin-investigations','/admin/investigations',['GET']],['admin-investigation','/admin/investigations/{id}',['GET']],['admin-investigation-start','/admin/investigations',['POST']],['admin-investigation-note','/admin/investigations/{id}/notes',['POST']],['admin-investigation-resolve','/admin/investigations/{id}/resolve',['POST']],['admin-expected-actual','/admin/subscriptions/{id}/expected-actual',['GET']],['admin-why-not-renewed','/admin/subscriptions/{id}/why-not-renewed',['GET']]] as [$name,$path,$methods]) $routes->add($name,new Route($path,['_handler'=>$name],[],[], '',[],$methods));
            $routes->add('creators',new Route('/creators',['_handler'=>'creators'],[],[], '',[],['GET']));
            $routes->add('admin-creators',new Route('/admin/creators',['_handler'=>'admin-creators'],[],[], '',[],['GET']));
            $routes->add('admin-creators-reconcile',new Route('/admin/creators/reconciliation',['_handler'=>'admin-creators-reconcile'],[],[], '',[],['GET','POST']));
            $routes->add('admin-user-creator',new Route('/admin/users/{id}/creator',['_handler'=>'admin-user-creator'],[],[], '',[],['POST']));
            $routes->add('admin-user-creator-suspend',new Route('/admin/users/{id}/creator/suspend',['_handler'=>'admin-user-creator-suspend'],[],[], '',[],['POST']));
            $routes->add('creator-payout',new Route('/creators/payouts',['_handler'=>'creator-payout'],[],[], '',[],['POST']));
    ...
    private static function adminPermission(string $handler): string
    {
        return match (true) {
            ...
            $handler==='admin-operations' || $handler==='admin-operation' || $handler==='admin-provisioning' => 'operations.view',
            $handler==='admin-provisioning-retry' => 'operations.retry_provisioning',
            $handler==='admin-explain' || $handler==='admin-preview-extend' || $handler==='admin-time-travel' || $handler==='admin-simulator' || $handler==='admin-dependency-graph' || $handler==='admin-intelligence' || str_starts_with($handler,'admin-investigation') || $handler==='admin-expected-actual' || $handler==='admin-why-not-renewed' => 'operations.view',
            $handler==='admin-invariants-run' || $handler==='admin-safety-mode' || $handler==='admin-maintenance-window' => 'admin.settings',
            $handler==='admin-flags' || $handler==='admin-flag-save' || $handler==='admin-switches' || $handler==='admin-switch-save' || $handler==='admin-breaker-reset' || $handler==='admin-approvals' || $handler==='admin-approval-decision' => 'admin.settings',
            $handler==='admin-events' || $handler==='admin-incidents' || $handler==='admin-incident-create' => 'operations.view',
            ...
            str_starts_with($handler,'admin-creators') => 'admin.withdrawals',
    ...
    private function dispatch(string $handler,string $id): Response
    {
        ...
        switch ($handler) {
            ...
            case 'renew':
                // Продлить существующую подписку (extend от текущей даты окончания),
                ...
                $plan=$db->one('SELECT * FROM plans WHERE id=? AND active=1',[$sub['plan_id']]);
                if (!$plan) throw new BillingError('Тариф подписки больше недоступен.');
                $order=$this->app->billing->order($uid,$plan['id'],'renew:'.$id.':'.$this->request->request->get('key',Database::id()),$input->get('receipt_email'),self::clientIp($this->request),$id,null);
                return new RedirectResponse('/orders/'.$order['id'],303);
            case 'merge':
                $this->app->killSwitch->assertCanPurchase($this->app->config['PAYMENT_DRIVER']);
                $sourceId=$input->get('source_id','');
                $targetId=$input->get('target_id','');
                if ($sourceId==='' || $targetId==='') throw new BillingError('Выберите обе подписки для объединения.');
                $this->app->merger->merge($uid,$sourceId,$targetId);
                return new RedirectResponse('/',303);
            case 'trial':
            ...
            case 'creators':
                $dashboard=$this->app->creators->dashboard($uid);
            ...
            case 'admin':
                ...
                $metrics=['revenue'=>(int)($db->one("SELECT COALESCE(SUM(amount_minor),0) v FROM payments WHERE status='succeeded' AND provider_payment_id NOT LIKE 'balance_%' AND paid_at>=?",[$today])['v']??0),'payments'=>(int)($db->one("SELECT COUNT(*) v FROM payments WHERE status='succeeded' AND provider_payment_id NOT LIKE 'balance_%' AND paid_at>=?",[$today])['v']??0),'active'=>(int)($db->one("SELECT COUNT(*) v FROM subscriptions WHERE lifecycle_status='active' AND expires_at>?",[time()])['v']??0),'attention'=>(int)($db->one("SELECT COUNT(*) v FROM provisioning_accounts WHERE state IN ('retry','failed')")['v']??0)+(int)($db->one("SELECT COUNT(*) v FROM payments WHERE status='pending'")['v']??0)];
    ...
    private function authentication(string $mode,string $token=''): Response
    {
        ...
        if ($this->request->isMethod('POST')) {
            ...
            if ($mode==='register') $this->app->creators->attachRegistration($uid,$this->request->cookies->get('creator_attr',''));
            ...
            $response=$this->signedIn($session);
            if ($mode==='register') $response->headers->clearCookie('creator_attr');
            return $response;
        }
