...
final class Application
{
    ...
    private static function adminPermission(string $handler): string
    {
        return match (true) {
            ...
            $handler==='admin-incidents' || $handler==='admin-incident-create' => 'operations.view',
