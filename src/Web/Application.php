...
final class Application
{
    ...
    private static function adminPermission(string $handler): string
    {
        return match (true) {
            ...
            $handler==='admin-explain' || $handler==='admin-preview-extend' || $handler==='admin-time-travel' || $handler==='admin-simulator' || $handler==='admin-dependency-graph' || $handler==='admin-intelligence' => 'operations.view',
